...
import styles from './HostelRoomPhotoSlider.module.css';

export default function HostelRoomPhotoSlider({ item }) {
  // const images = [
    ...
    <div className={styles.sliderContainer}>
      <Slider {...settings}>
        {images.map((img, index) => (
          <div key={index} >
            <img className={styles.imgSlider} src={img.src} alt='hotel' />
          </div>
        ))}
      </Slider>
    </div>
